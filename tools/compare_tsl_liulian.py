...
def build_tsl_cmd(exp: Experiment, epoch_limit: Optional[int] = None) -> list[str]:
...
def build_liulian_cmd(
    exp: Experiment, epoch_limit: Optional[int] = None,
) -> list[str]:
...
def main() -> None:
    ...
    for exp in experiments:
        ...
        tsl_cmd = build_tsl_cmd(exp, epoch_limit=epoch_limit)
        ll_cmd = build_liulian_cmd(exp, epoch_limit=epoch_limit)
