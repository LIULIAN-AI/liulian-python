"""
LightTS: Lightweight Time Series Forecasting with Adaptive Decomposition
...
A pure MLP-based model that uses continuous / interval sampling strategies
with IEBlock (spatial + channel projection) for efficient time series
forecasting without attention mechanisms. Includes an autoregressive linear
skip connection.
"""
...
class IEBlock(nn.Module):
    """Interval/Entity Block — spatial + channel projection."""
...
class Model(nn.Module):
    """LightTS — lightweight MLP model for time series forecasting.
    ...
    def __init__(self, configs, chunk_size=24):
        ...
        Args:
            ...
            chunk_size: Reshape T into ``[num_chunks, chunk_size]``.
        """
