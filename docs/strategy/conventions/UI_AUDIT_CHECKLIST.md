...
- [ ] **Code reuse vs visual originality kept clean.** No screenshot
      of the new surface should look like a liulian / Refine.dev /
      shadcn-template screen with text swapped. (LIULIAN_REUSE_MAP
      §0.1)
...
- [ ] **Category-reflex test**: could the palette be guessed from
      ...
      strategy.
- [ ] **LIULIAN-copy test**: does the page look like a liulian
...
A. Sacred rules     ✓ originality kept (no liulian lookalike); bilingual ✓
