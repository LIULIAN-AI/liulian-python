...
| Project | Key Files |
|---|---|
| Time-LLM-Revised | [run_main.py](refer_projects/Time-LLM-Revised/run_main.py), [utils/tools.py](refer_projects/Time-LLM-Revised/utils/tools.py), [configs/srnb.yaml](refer_projects/Time-LLM-Revised/configs/srnb.yaml), [scripts/TimeLLM_ETTh1.sh](refer_projects/Time-LLM-Revised/scripts/TimeLLM_ETTh1.sh) |
| swiss-river-benchmark | [benchmark/training.py](refer_projects/swiss-river-network-benchmark/swissrivernetwork/benchmark/training.py), [benchmark/ray_tune.py](refer_projects/swiss-river-network-benchmark/swissrivernetwork/benchmark/ray_tune.py), [benchmark/train_single_model.py](refer_projects/swiss-river-network-benchmark/swissrivernetwork/benchmark/train_single_model.py) |
| liulian | [runtime/trainer.py](liulian/runtime/trainer.py), [experiments/swiss_river/run.py](experiments/swiss_river/run.py) |
